...
<script>
import sectionPresentation from "../components/challengeKetoAyuno/sections/presentation.vue";
import sectionMoreInfo from "../components/challengeKetoAyuno/sections/moreInfo.vue";

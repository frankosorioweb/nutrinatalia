<template>
  <div class="mb-7 grey lighten-5 details-page">
    <v-main>
      <template v-if="this.showCarrousel">
        <div>
          <v-row no-gutters>
            <v-col>
              <template v-if="this.showCarrousel">
                <div>
                  <div id="image-slider" ref="imageSlider" class="splide">
                    <div class="splide__track">
                      <ul class="splide__list">
                        <template v-for="item in data.carrouselImgs">
              ...
              <v-img v-else :class="{ rounded: $vuetify.breakpoint.mdAndUp }" :aspect-ratio="16 / 9"
                :src="product.poster">
                    ...
                    <v-row no-gutters>
                      ...
                      <v-col cols="12">
                        <template v-if="product.customCTA">
                          <v-btn :href="product.customCTA.link" :to="product.customCTA.to"
                            :target="product.customCTA.target" color="primary" block>
...
export default {
  ...
  computed: {
    ...
    data() {
      return {
        carrouselImgs: this.infoProduct == 'e-book-dulces-saludables' ? [
        ...
        '/img/posters/carrusel-ebook-navidad-lowcarb/extra-info-min.jpg',
          ...
          '/img/posters/e-book-fermentados/3-combucha-min.jpg',
          '/img/posters/e-book-fermentados/4-chucrut-min.jpg',
          '/img/posters/e-book-fermentados/5-pickles-min.jpg',
          '/img/posters/e-book-fermentados/6-yogur-min.jpg',
          '/img/posters/e-book-fermentados/7-queso-crema-min.jpg',
        ]
      }
    },
    productsArr() {
    ...
    showCarrousel() {
      return this.productsArr.includes(this.infoProduct);
    },
    product() {
  ...
  mounted() {
    console.log(this.showCarrousel);
